...
#RUN sed -e '/jdk.tls.disabledAlgorithms=/ s/^#*/#/g' -i /usr/lib/jvm/java-11-openjdk-11.0.9.11-0.el7_9.x86_64/conf/security/java.security
...
# Start Docker deamon
# docker build -t iam-sftp-adapter:iam_1.9 .
# Tag it and push to quay
# docker tag iam-sftp-adapter:iam_1.9 quay.io/msentissi/iam-sftp-adapter:iam_1.9
# docker login registry.redhat.io 
# docker push quay.io/msentissi/iam-sftp-adapter:iam_1.9
# OR tag it and push to dockerhub
# docker push msentissi/iam-sftp-adapter:iam_1.9

# docker run --rm -ti iam-sftp-adapter:iam_1.9