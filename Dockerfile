...
##Need to build a new image, lo tienes abajo :
    ...
    # Start Docker deamon
    # docker build -t iam-sftp-adapter:iam_3.6 .
    # Tag it and push to quay
    # docker tag iam-sftp-adapter:iam_3.6 quay.io/msentissi/iam-sftp-adapter:iam_3.6
    # docker login registry.redhat.io 
    # docker push quay.io/msentissi/iam-sftp-adapter:iam_3.6
    # OR tag it and push to dockerhub
    #   docker push msentissi/iam-sftp-adapter:iam_3.6

    # docker run --rm -ti iam-sftp-adapter:iam_3.6
    # docker run --env JAVA_OPTS="-Xms256m -Xmx5024m" --network host --rm -ti iam-sftp-adapter:iam_3.6
    # docker run --rm -ti --network="host" -e sFTP_HOST="130.24.80.145" -e sFTP_PWD="123456" iam-sftp-adapter:iam_3.6
